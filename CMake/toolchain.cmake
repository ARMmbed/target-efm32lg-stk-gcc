...
if(TARGET_EFM32LG_STK_GCC_TOOLCHAIN_INCLUDED)
    return()
endif()
set(TARGET_EFM32LG_STK_GCC_TOOLCHAIN_INCLUDED 1)
...
#
add_definitions("-DEFM32LG990F256 -DEFM32LG -DEFM32")

# append non-generic flags, and set EFM32LG-specific link script
...
set(CMAKE_EXE_LINKER_FLAGS_INIT    "${CMAKE_EXE_LINKER_FLAGS_INIT} -mcpu=cortex-m3 -mthumb -T\"${CMAKE_CURRENT_LIST_DIR}/../ld/efm32lg.ld\"")
